...
ggplot(data, aes(h0)) +
  ...
  ggtitle('Histogram of height at birth')
```
...
ggplot(data, aes(sample=w0)) +
  ...
  ggtitle('QQ-plot of birth weight')
```
...
ggplot(data, aes(sample=h0)) +
  stat_qq(na.rm=TRUE) + stat_qq_line(na.rm=TRUE) +
  ggtitle('QQ-plot of height at birth')
```
...
ggplot(data, aes(w0, h0)) +
  ...
  ggtitle("Scatterplot of height and weight at birth") + xlab("Weight (grams)") + ylab("Height (cm)")
```
